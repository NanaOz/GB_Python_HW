...
from game_tic_tac_toe import*
# Задача 1
# Напишите программу, удаляющую из текста все слова, содержащие ""абв"".
print("ЗАДАЧА 1")
my_text = 'увидала я в окне принц на сказочном коне как мечтала я о нем встрече с принцем и конем'
print(f'Исходный текст:  {my_text}')


def del_some_char(txt):
    my_text_list = list(filter(lambda i: 'а' not in i and 'б' not in i and 'в' not in i, txt.split()))
    return my_text_list
