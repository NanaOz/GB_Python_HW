...
* Кнопки:
    ...
    + как дела? - ответит, как дела, и просит как дела у вас, 2 варианта ответа в инлайн кнопках (в зависимости от выбраной кнопки - пришлет стикер и сообщение):
        + отлично
        + не очень
 
## HW_10
Телеграм-бот
* /start - поздоровается с Вами по имени, спросит что хотите, пришлет стикер по ид
* Кнопки:
    + отгадай число - бот загадал число, пользователю нужно его отгадать
    + гороскоп - при выборе своего знака(инлайн кнопка) - выдаст твой гороскоп(из файла)
* если вводится пользователем, то что бот не умеет - присылает стикер и просит выбрать то, что он умеет.
